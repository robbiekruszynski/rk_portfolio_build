...
const SLIDES = [
  { src: '/images/deepscry-1.png', label: 'Curve: mana curve, card types, and color identity' },
  { src: '/images/deepscry-2.png', label: 'Probabilities: opening-hand scenarios and card tags' },
  { src: '/images/deepscry-3.png', label: 'Overview: deck health vs benchmark metas and mana odds' },
]

const DeepscryCarousel = () => {
  ...
  return (
    <div
      ...
      aria-label="Deepscry screenshots"
      tabIndex={0}
      onKeyDown={e => {
        if (e.key === 'ArrowLeft') {
          e.preventDefault()
...
export default DeepscryCarousel
